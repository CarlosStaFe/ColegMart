...
{
    public partial class frmQueryCodPostal : Form
    {
        CN_Localidades cN_Localidades = new CN_Localidades();

        string NombreBoton;
        public frmQueryCodPostal(string NombreBoton)
        {
            InitializeComponent();
        ...
        private void dgvCodPostales_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvCodPostales.Columns[e.ColumnIndex].Name == "Seleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    txtIdLocal.Text = dgvCodPostales.Rows[indice].Cells["id_Local"].Value.ToString();
                    ...
                    if (NombreBoton == "btnLocalParti")
                    {
                        ...
                        ColegParti.txtLocalParti.Text = txtIdLocal.Text;
                    ...
                    if (NombreBoton == "btnLocalLabor")
                    {
                        ...
                        ColegLabor.txtLocalLabor.Text = txtIdLocal.Text;
