...
namespace CapaPresentacion
{
    public class DatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.calendario16;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.calendario16;
                else calendarIcon = Properties.Resources.calendario16;
                this.Invalidate();
            }
        }
        ...
        //Anulamos los siguientes métodos
