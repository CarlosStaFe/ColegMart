...
namespace CapaPresentacion.Formularios
{
    public partial class mdlEstratoBco : Form
    {
        ...
        private void cboBancos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                dgvEstrato.Rows.Add(new object[] { item.id_Estra, item.idBanco, item.Fecha, item.Referencia, item.Causal, item.Concepto, item.Debito, item.Credito, item.FechaConci, item.Titular, item.NroCic });
            }
