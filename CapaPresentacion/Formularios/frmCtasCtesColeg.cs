    ...
    public partial class frmCtasCtesColeg : Form
    {
        ...
        private void CargarDGV()
        {
            ...
            if (ListaCtaCte.Count > 0)
            {
                ...
                {
                    dgvCtasCtes.Rows.Add(new object[] { item.id_CtaCte, item.fk_idColeg, item.Matricula, item.Fecha, item.Tipo, item.Subfijo, item.Item, item.fk_idDebito,
        ...
        private void PintarDGV()
        {
            if (dgvCtasCtes.Rows.Count > 0)
            {
                foreach (DataGridViewRow fila in dgvCtasCtes.Rows)
                {
                    ...
                    saldo = saldo + Convert.ToDecimal(fila.Cells["Saldo"].Value.ToString());
        ...
        private void LeerColegiado()
        {
            ...
            foreach (CE_Colegiados item in ListaBuscado)
            {
                ...
                lblColegiado.Text = matriculado + " - Estado: " + estado;
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            Mostrar.detalle = "Listado de cuenta corriente de " + txtMatricula.Text + " - " + matriculado + " - Estado: " + estado + " - Vto. Fianza: " + fianza;
